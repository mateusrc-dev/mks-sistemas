  ...
  return (
      <Html>
        <Head>
          ...
          <style id="stitches" dangerouslySetInnerHTML={{ __html: getCssText() }} /> {/*a função getCssText vai, ao usuário carregar a página pelo lado do servidor, carregar essa página, ver qual código css necessário para a página e retornar dessa função - com isso o css vai ser habilitado mesmo com o js desabilitado - com isso estamos trazendo o css pronto do lado do servidor - com isso a aplicação ganha performance também pois o servidor é mais rápido que o browser*/}
        </Head>
